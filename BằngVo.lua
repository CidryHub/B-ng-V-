...
if  game.Players.LocalPlayer.Name == "Cidry" or  game.Players.LocalPlayer.Name == "Cid_Kagenou" then
DiscordLib:Notification("Thông Báo" , "Chào Bạn, Mình Là Admin Bản Bằng Võ Hub" , 6 ,11816162894)
    DiscordLib:Notification("Thông Báo" , "Cảm Ơn Bạn Đã Sử Dụng Bằng Võ Hub" , 8,11816162894)
